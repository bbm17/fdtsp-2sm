    ...
    for seed in range(1, nrSeeds + 1):
        ...
        for it in range(0,iter_proposed_model):
            ...
            for i, idx in enumerate(noLaunched_indices_d3):
                ...
                list_dr3_new.insert(i, [])
                k +=1
            count_total = count1 + count2 + count3 ### AGREGAR
            for i, idx in enumerate(noLaunched_indices_d1):
        ...
        ############################## COMBINATION BETWEEN TRUCK AND DRONES BEGIN ###########################
            ...
            if d1_tr_new.count('NO LAUNCHED 2') == 0 and d2_tr_new.count('NO LAUNCHED 2') ==0 and d3_tr_new.count('NO LAUNCHED 2') ==0:
                ...
                # time_drone = [max(nueva_time_d1[i],nueva_time_d2[i],nueva_time_d3[i]) for i in range(len(nueva_time_d1))] #nueva_time_drone
