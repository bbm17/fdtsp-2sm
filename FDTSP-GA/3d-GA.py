...
def main(name_file, instances_path, soluciones_folder):
    ...
    for seed in range(1, nrSeeds + 1):
        ...
        for it in range(0,iter_proposed_model):
            ...
            if d1_tr_new.count('NO LAUNCHED 2') == 0 and d2_tr_new.count('NO LAUNCHED 2') ==0 and d3_tr_new.count('NO LAUNCHED 2') ==0:
                ...
                for i in indices_3:
                    ...
                    nueva_time_d2.append(0)
                    nueva_time_d3.append(0)
                waiting_drone = [max(nueva_waiting_time_dr1[i],nueva_waiting_time_dr2[i],nueva_waiting_time_dr3[i]) for i in range(len(nueva_waiting_time_dr1))] #nueva_waiting_drone
                ...
                del (indices_1,indices_2,indices_3,
                nueva_list_trucks_new,nueva_road_map,
                nueva_waiting_time_dr1,nueva_waiting_time_dr2,nueva_waiting_time_dr3, 
                nueva_time_d1,nueva_time_d2,nueva_time_d3)
