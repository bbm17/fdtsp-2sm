        ...
        for it in range(0,iter_proposed_model):
            ...
            for k in range(len(d2_tr)):
                if d2_travel[k] > endurance2*delta*speed_drone and 2*d2_tr[k] < (endurance2-(0.5/60))*speed_drone:
                    ...
                    d2_ntr_new[k] = 'NO LAUNCHED 2' #REPLACED NODES CHECKING
                else:
                    d2_tr_new[k] = d2_tr[k]
            ...
            if d1_tr_new.count('NO LAUNCHED 2') == 0 and d2_tr_new.count('NO LAUNCHED 2') ==0:
                ...
                waiting_drone = [max(nueva_waiting_time_dr1[i],nueva_waiting_time_dr2[i]) for i in range(len(nueva_waiting_time_dr1))] #nueva_waiting_drone
                ...
                del (indices_1,indices_2,
                nueva_list_trucks_new,nueva_road_map,
                nueva_waiting_time_dr1,nueva_waiting_time_dr2,
                nueva_time_d1,nueva_time_d2,)
